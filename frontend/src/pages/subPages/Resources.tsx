...
const Resources = () => {
  ...
  //     description:
  //       "Ut voluptatibus natus sed doloribus quasi illo praesentium.",
  //     category: "Beauty",
  //     tag: "request",
  //     id: "3",
  //   },
  ...
  //     description:
  //       "Ut doloribus aut id voluptatem culpa molestias error totam.",
  //     category: "Home",
  //     tag: "user",
  //     id: "12",
  //   },
  ...
  //     description:
  //       "Quibusdam aut maiores nam quis similique id exercitationem.",
  //     category: "Music",
  //     tag: "request",
  //     id: "17",
  //   },
  ...
  return (
    <>
      <div className="card-container flex justify-center mt-10 items-center flex-wrap h-full m-auto gap-5 w-[80%]">
        {cardData.map((card) => (
          <DisplayCard
            key={card.id}
            title={card.title}
